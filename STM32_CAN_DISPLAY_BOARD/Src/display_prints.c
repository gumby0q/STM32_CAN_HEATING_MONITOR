...
void display_update2(u8g2_t *p_u8g2, struct display_screen1_data *screen_data, struct display_screen1_error_message *screen_error) {
	...
	do {
		...
		// u8g2_SetFont(p_u8g2, u8g2_font_helvB24_tf);
		// u8g2_SetFont(p_u8g2, u8g2_font_helvR24_tf);
		// u8g2_SetFont(p_u8g2, u8g2_font_timB24_tf);
		u8g2_SetFont(p_u8g2, u8g2_font_timR24_tf);
		// u8g2_SetFont(p_u8g2, u8g2_font_VCR_OSD_tf);
		// u8g2_SetFont(p_u8g2, u8g2_font_courB18_tf);
		sprintf(tmp_string, "%s %sC", screen_data->str_boiler_value, "\xb0");
		u8g2_DrawStr(p_u8g2, 0, 24, tmp_string);


		u8g2_SetFont(p_u8g2, u8g2_font_courR08_tf);
		
		// u8g2_SetFont(p_u8g2, u8g2_font_courB10_tf);
		sprintf(tmp_string, "Boiler t error: %s", screen_data->str_boiler_error);
		...
		/* pump status 1 */
		sprintf(tmp_string, "pump1:%s", screen_data->str_pump_1_status);
		// u8g2_DrawStr(p_u8g2, 0, 45, tmp_string);
		u8g2_DrawStr(p_u8g2, 0, 50, tmp_string);
